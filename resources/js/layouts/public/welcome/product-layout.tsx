...
export default function ProductLayout({ products = [] }: { products?: Array<{ id: number; title: string; description: string; price: number; compare_at_price?: number; product_category?: { name: string }; images?: string[] }> }) {
                    ...
                    {products.map((product) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#contact" className="font-serif text-xs text-[#c9a07a] hover:text-[#281b10] transition-colors tracking-wide">
                                    Order →
                                </a>
                            </div>
                        </motion.div>
